...
macro(OCV_OPTION variable description value)
  ...
  if(${__condition})
    if("${__value}" MATCHES ";")
      if(${__value})
        yong_option(${variable} "${description}" ON)
      else()
        yong_option(${variable} "${description}" OFF)
      endif()
    elseif(DEFINED ${__value})
      ...
      yong_option(${variable} "${description}" ${__value})
    endif()
  else()
...
macro(ocv_finalize_status)
  if(NOT OPENCV_SKIP_STATUS_FINALIZATION)
    if(TARGET opencv_core)
      execute_process(COMMAND ${CMAKE_COMMAND} -E copy_if_different "${OPENCV_BUILD_INFO_FILE}" "${OpenCV_BINARY_DIR}/modules/core/version_string.inc" OUTPUT_QUIET)
    endif()
  endif()
endmacro()
